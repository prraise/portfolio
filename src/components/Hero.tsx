    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full py-12 lg:py-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-5 flex justify-center items-center" id="hero-illustration">
            <div className="relative w-full max-w-md aspect-square flex items-center justify-center">
              
              {/* Outer Pulsing Glow Circle */}
              <div className="absolute inset-0 rounded-full bg-gradient-to-tr from-[#93C5FD]/10 to-[#A78BFA]/10 animate-pulse" />
              
              {/* Inner tech glass visual board */}
              <div className="relative w-4/5 h-4/5 bg-white/80 backdrop-blur-md rounded-3xl border border-purple-100 shadow-xl p-6 flex flex-col justify-between overflow-hidden group shadow-purple-100/10">
                <div className="absolute -top-12 -right-12 w-24 h-24 bg-purple-200/20 rounded-full blur-2xl group-hover:bg-purple-250/30 transition-all duration-500" />
                
                {/* Header detail */}
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-1.5">
                    <span className="w-2 h-2 rounded-full bg-purple-500 animate-ping" />
                    <span className="text-[10px] font-mono text-purple-600 tracking-widest uppercase font-bold">System: Active</span>
                  </div>
                  <BrainCircuit className="text-[#A78BFA] w-5 h-5 animate-spin-slow" />
                </div>

                 {/* Main animated neural node panel */}
                <div className="my-auto py-4 flex flex-col items-center justify-center relative animate-fade-in">
                  <svg
                ...
                {/* Custom Console Print Area */}
                <div className="bg-purple-50/50 rounded-xl p-3 border border-purple-100 font-mono text-[10px] text-purple-800 space-y-1 text-left">
                  ...
                  <div className="flex gap-2">
                    <span className="text-purple-400">&gt;_</span>
                    <span>model = ml.train(specialization)</span>
                  </div>
                  <div className="text-slate-600 flex justify-between items-center bg-white/40 px-1 py-0.5 rounded border border-purple-50">
